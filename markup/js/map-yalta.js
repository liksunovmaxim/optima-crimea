function init_google_map(map_coords, map_type) {
    ...
    var isDraggable = jQuery(document).width() > 550 ? true : false;
    ...
    var map = new google.maps.Map(document.getElementById('map-yalta'), mapOptions);
...
init_google_map("44.493224,34.129051", "road");